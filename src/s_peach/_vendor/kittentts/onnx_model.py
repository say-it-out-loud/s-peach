...
# espeakng-loader bundles espeak-ng as a Python package.  phonemizer
# only finds it when the library path and data path are exposed via
# environment variables *before* phonemizer probes for espeak.
try:
